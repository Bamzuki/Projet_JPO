...
public class EcoleActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 2- Recupération des formations et événements
        listView = (ExpandableListView)findViewById(R.id.liste_extensions);
        initData();
    ...
    private void initData() {
        ...
        listDataHeader.add("Formation proposées");
        listDataHeader.add("Evénements");

        List<String> formations = new ArrayList<>();
        formations.add("C'est une vue extensible");

        List<String> evenements = new ArrayList<>();
        evenements.add(" androidStudio vue extensible");
        evenements.add(" androidStudio google map");
        evenements.add(" androidStudio chat application");

        listHashMap.put(listDataHeader.get(0), formations);
        listHashMap.put(listDataHeader.get(1), evenements);
    }
