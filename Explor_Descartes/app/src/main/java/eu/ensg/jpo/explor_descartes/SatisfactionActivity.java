...
public class SatisfactionActivity extends template {
    ...
    /**
     * Cette classe gère les réponses au questionnaire de satisfaction et les envoie dans la base
     * de données
     */
    ...
    public void validation() {
        /**
         * Fonction qui envoie les réponses du questionnaire de satisfaction de l'utilisateur
    ...
    public String checked(ArrayList<CheckBox> checkBoxes){
         ...
         *
         * @param checkboxes : les  checkbox du questionnaire
         * @return les valeurs des checkbox sous forme de chaînes de caractères
         */
